...
window.NarrationData = {
  ...
  entries: [
    ...
    { id: "voice-quiz", audioIndex: 10, text: "Can you tell which voice is real? Go ahead, take a guess. The technology to clone voices is now available to anyone.", duration: 8000 },
    { id: "background-check", audioIndex: 8, text: "Background check? All clear. Because Marcus Chen's identity is built on real patterns — just not a real person.", duration: 7000 },
    { id: "every-stage", audioIndex: 11, text: "So let's recap what Marcus can do. Fake identity that passes screening. Deepfake video for interviews. Cloned voice that sounds authentic. Background check comes back clean.", duration: 13000 },
    ...
    { id: "bad-hire-cost", audioIndex: 16, text: "What happens when a bad hire gets in? Average cost? Over $240,000. But that's just incompetence.", duration: 7000 },
    { id: "malicious", audioIndex: 17, text: "What if they're malicious? Insider threats cause the most devastating breaches — and you just hired one.", duration: 6000 },

    // === Act 3: The Solution (slides 20-25) ===
    { id: "clarity-intro", audioIndex: 20, text: "Clarity provides end-to-end identity validation for the entire hiring lifecycle — from the first resume to their last day on the job.", duration: 9000 },
    ...
    { id: "lifecycle", audioIndex: 29, text: "The employee identity lifecycle — from onboarding to MFA resets, to privileged access, to periodic checks. Every critical moment, verified.", duration: 10000 },
    { id: "two-pillars", audioIndex: 25, text: "But here's the practical reality — a solution that doesn't fit into your existing workflow is a solution that won't get used.", duration: 8000 },
    { id: "two-pillars", audioIndex: 26, text: "That's why Clarity is built on two pillars — deep workflow integration, and deep security in the background.", duration: 7000 },
    { id: "integrations", audioIndex: 27, text: "Pillar A. We integrate into the tools you already use. Greenhouse, Lever, Workday, Okta, Zoom, Slack. No new workflows to learn.", duration: 10000 },
